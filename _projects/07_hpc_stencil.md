...
importance: 2
category: HPC
code: https://github.com/Jac-Zac/HPC_Final_Project
slides: https://canva.link/eyg24os7b2z8kkh
---
...
{% include figure.liquid path="assets/img/hpc_openmp_speedup.png" class="img-fluid rounded z-depth-1 my-3" alt="OpenMP speedup on Leonardo: spread binding above close until bandwidth saturates near 27x" zoomable=true %}
...
{% include figure.liquid path="assets/img/hpc_mpi_time_breakdown.png" class="img-fluid rounded z-depth-1 my-3" alt="MPI time breakdown: computation dominates, communication stays small and decreases with task count" zoomable=true %}
...
Profile-guided optimization and huge pages were tested without benefit (cluster TLB miss rates are already low). MPI Cartesian topology, temporal blocking, and `MPI_Waitsome` on borders remain as future work. The main takeaway is to profile before optimizing and to profile on the machine that will run the code.
